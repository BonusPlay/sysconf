    ...
    passthru = {
      fhs = buildFHSEnv {
        ...
        extraPreBwrapCmds = ''
          ...
          ls -lha var/
          ls -lha var/www/
          ls -lha var/www/onlyoffice/
          ls -lha var/www/onlyoffice/documentserver/
          ls -lha var/www/onlyoffice/documentserver/sdkjs/
          ls -lha var/www/onlyoffice/documentserver/sdkjs/common/
          echo "============================================================"
          ls -lha var/
          ls -lha var/lib/
          ls -lha var/lib/onlyoffice/
          ls -lha var/lib/onlyoffice/documentserver/
          ls -lha var/lib/onlyoffice/documentserver/sdkjs/
          ls -lha var/lib/onlyoffice/documentserver/sdkjs/common/
          echo "============================================================"
          set -x
        '';
